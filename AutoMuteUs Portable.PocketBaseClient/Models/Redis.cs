...
public partial class Redis : ItemBase
{
    ...
    [PocketBaseField("1gp9b14a", "name", true, false, true, "text")]
    [Display(Name = "Name")]
    ...
    [PocketBaseField("0mzkpso2", "sha256", true, false, false, "text")]
    [Display(Name = "Sha256")]
    ...
    [PocketBaseField("y3xvrb55", "download_url", true, false, false, "text")]
    ...
    [PocketBaseField("19esueem", "compatibleExecutors", true, false, false, "relation")]
