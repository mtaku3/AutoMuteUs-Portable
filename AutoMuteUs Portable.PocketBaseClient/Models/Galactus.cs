...
public partial class Galactus : ItemBase
{
    ...
    [PocketBaseField("x1dzx952", "name", true, false, true, "text")]
    [Display(Name = "Name")]
    ...
    [PocketBaseField("1yrej26q", "sha256", true, false, false, "text")]
    [Display(Name = "Sha256")]
    ...
    [PocketBaseField("vu4ylqa9", "download_url", true, false, false, "text")]
    ...
    [PocketBaseField("owy480ko", "compatibleExecutors", true, false, false, "relation")]
