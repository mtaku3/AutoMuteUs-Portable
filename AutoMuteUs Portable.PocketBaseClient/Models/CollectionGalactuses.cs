...
public class CollectionGalactuses : CollectionBase<Galactus>
{
    public CollectionGalactuses(DataServiceBase context) : base(context)
    {
    }
    ...
    /// <inheritdoc />
    public override string Name => "galactuses";
