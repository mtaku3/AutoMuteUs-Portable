...
public class CustomCompositeDisposable : ICollection<IDisposable>, ICancelable
{
    ...
    /// <summary>
    ///     Initializes a new instance of the <see cref="CustomCompositeDisposable" /> class with no disposables contained by
    ///     it
    ///     initially.
    /// </summary>
    public CustomCompositeDisposable()
    {
        _disposables = new List<IDisposable?>();
    }

    /// <summary>
    ///     Initializes a new instance of the <see cref="CustomCompositeDisposable" /> class with the specified number of
    ///     disposables.
    /// </summary>
    /// <param name="capacity">The number of disposables that the new CompositeDisposable can initially store.</param>
    /// <exception cref="ArgumentOutOfRangeException"><paramref name="capacity" /> is less than zero.</exception>
    public CustomCompositeDisposable(int capacity)
    {
    ...
    /// <summary>
    ///     Initializes a new instance of the <see cref="CustomCompositeDisposable" /> class from a group of disposables.
    /// </summary>
    /// <param name="disposables">Disposables that will be disposed together.</param>
    /// <exception cref="ArgumentNullException"><paramref name="disposables" /> is <c>null</c>.</exception>
    /// <exception cref="ArgumentException">
    ///     Any of the disposables in the <paramref name="disposables" /> collection is
    ///     <c>null</c>.
    /// </exception>
    public CustomCompositeDisposable(params IDisposable[] disposables)
    {
    ...
    ///     <c>null</c>.
    /// </exception>
    public CustomCompositeDisposable(IEnumerable<IDisposable> disposables)
    {
        if (disposables == null) throw new ArgumentNullException(nameof(disposables));
    ...
    private static List<IDisposable?> ToList(IEnumerable<IDisposable> disposables)
    {
        ...
        {
            if (d == null) throw new ArgumentException("Disposables cannot contain null", nameof(disposables));
    ...
    /// <summary>
    ///     Gets the number of disposables contained in the <see cref="CustomCompositeDisposable" />.
    /// </summary>
    public int Count => Volatile.Read(ref _count);

    /// <summary>
    ///     Adds a disposable to the <see cref="CustomCompositeDisposable" /> or disposes the disposable if the
    ///     <see cref="CustomCompositeDisposable" /> is disposed.
    /// </summary>
    ...
    /// <summary>
    ///     Removes and disposes the first occurrence of a disposable from the <see cref="CustomCompositeDisposable" />.
    /// </summary>
    ...
    /// <summary>
    ///     Removes and disposes all disposables from the <see cref="CustomCompositeDisposable" />, but does not dispose the
    ///     <see cref="CustomCompositeDisposable" />.
    /// </summary>
    public void Clear()
    {
        ...
        foreach (var d in previousDisposables) d?.Dispose();
    }

    /// <summary>
    ///     Determines whether the <see cref="CustomCompositeDisposable" /> contains a specific disposable.
    /// </summary>
    ...
    /// <summary>
    ///     Copies the disposables contained in the <see cref="CustomCompositeDisposable" /> to an array, starting at a
    ///     particular
    ///     array index.
    /// </summary>
    ...
    /// <summary>
    ///     Returns an enumerator that iterates through the <see cref="CustomCompositeDisposable" />.
    /// </summary>
    ...
    private sealed class CompositeEnumerator : IEnumerator<IDisposable>
    {
        ...
        public bool MoveNext()
        {
            ...
            for (;;)
            {
                ...
                if (disposables[idx] != null) return true;
            }
        }
